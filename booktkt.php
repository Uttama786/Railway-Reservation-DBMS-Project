...
<body>
	...
	<form method="post" name="journeyform" onsubmit="return validate()">
		<select id="trains" name="trains" required>
			...
			<option value="rajdhani" >Hampi Express - SSS HUBBALI to Mysore Junction</option>
			<option value="duronto" >Karatagi Express - SSS HUBBALI to Karatagi</option>
			<option value="geetanjali">Gol Gumbaz Express - Pandarapura to Mysore Junction</option>
			<option value="garibrath" >Hospet Rath - CSMT to Hospete Junction</option>
